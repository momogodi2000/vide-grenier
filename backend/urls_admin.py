...
urlpatterns = [
    ...
    path('newsletter/subscribers/export/', newsletter_admin.export_subscribers_to_excel, name='newsletter_subscribers_export'),
    path('newsletter/subscribers/import/', newsletter_admin.import_subscribers, name='newsletter_subscribers_import'),
